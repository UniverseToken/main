...
let addr;
const sttaddr = "0x1214Dc40E36fDcC1b4e2adE748e334a6C602BF48";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x1214Dc40E36fDcC1b4e2adE748e334a6C602BF48";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://universetoken.finance/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0x1214Dc40E36fDcC1b4e2adE748e334a6C602BF48',
                    'symbol': 'UNI',
                    'decimals': '18',
                    'image': 'https://universetoken.finance/images/logo.png',
                },
            },
